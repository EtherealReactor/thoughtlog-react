...
export default ThoughtListHoc({ status: 'published' });
...
// 
//   componentDidMount(){
//     this.props.fetchThoughtsList('published');
...
// 
//   escFunction = () => {
//     this.setState({ id: '', showConfirm: false })
//   }
// 
//   render() {
...
// }
// 
// export default withRouter(connect(mapStateToProps, mapDispatchToProps)(AllThoughts));